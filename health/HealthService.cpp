 ...
 */
#define LOG_TAG "android.hardware.health@2.0-service.sagit"
...
using ::device::xiaomi::sagit::health::CycleCountBackupRestore;
using ::device::xiaomi::sagit::health::LearnedCapacityBackupRestore;
